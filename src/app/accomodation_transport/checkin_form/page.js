...
export default function AccomodationTransportForm() {
  ...
  return (
    <div className="max-w-4xl mx-auto p-6 sm:p-8 bg-gradient-to-br from-gray-50 to-gray-100 rounded-2xl shadow-xl mt-24">
      <h2 className="text-3xl font-bold text-gray-800 mb-6 text-center">Check-in Form</h2>
      ...
      <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {[
          ...
          <div key={name} className="relative">
            ...
            <input
              ...
              className={`w-full p-3 border rounded-lg shadow-sm focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all duration-200 ${
        ...
        <div>
          ...
          <select
            ...
            onChange={handleChange}
            className="w-full p-3 border border-gray-300 rounded-lg shadow-sm focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all duration-200"
            required
          >
