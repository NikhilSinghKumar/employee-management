...
import ConfirmDeleteDialog from "@/component/business_enquiry_actions/ConfirmDeleteDialog";
...
export default function BusinessEnquiryPage() {
  ...
  async function handleConfirmDelete() {
    try {
      const res = await fetch(
        `/api/sales/business_enquiry_private/${selectedEnquiry.id}`,
        { method: "DELETE" }
      );
  ...
  return (
    <>
      ...
      <ConfirmDeleteDialog
        ...
        companyName={selectedEnquiry?.company_name}
