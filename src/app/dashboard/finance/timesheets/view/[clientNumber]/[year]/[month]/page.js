...
export default function ClientTimesheetPage() {
  const { clientNumber, year, month } = useParams();
  ...
  useEffect(() => {
    ...
    fetchSummaryData();
  }, [clientName, clientNumber, year, month, currentPage, searchTerm]);
